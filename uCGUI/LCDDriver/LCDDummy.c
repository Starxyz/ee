...
//    /* ... */
//  }
//	//LCD_DisAPoint(319-y, x, PixelIndex);
//	LCD_DisAPoint(319-x, y,  PixelIndex);
//}
...
unsigned int LCD_L0_GetPixelIndex(int x, int y) {
 ...
 // }
	#if (LCD_DIR==1)
		PixelIndex = LCD_ReadAPoint(y, x);
	#else
		PixelIndex = LCD_ReadAPoint(319-x, y);
	#endif
  return PixelIndex;
}
...
//  }
	...
	#if (LCD_DIR==1)
		LCD_DisARectangular(y0,x0,y1,x1,LCD_COLORINDEX);
	#else
		LCD_DisARectangular(319-x1, y0, 319-x0, y1, LCD_COLORINDEX);
	#endif
